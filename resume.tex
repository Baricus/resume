...
%	
%	To Do:
%		- Revise projects section; it is currently unbalanced
%			Perhaps single column formatting or some hybrid?
%		- Ensure vertical formatting is correct
%			(long term goal: eliminate vspace)
%		- Lowecase GPA
%		- Expand additional activities section
%		- Make first branch for fair
...
%---------------------------------------------------------------------------Projects
%Similar to ``Skills,'' we put this section in two colums: prior and current projects
