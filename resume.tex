...
\begin{flushleft}
	\begin{tabularx}{\textwidth}[c]{X X}
		\begin{description}
			...
			\item Machine Organization (CS 261)
			\item Languages and Automata (CS 301)
	...
	\begin{tabularx}{\textwidth}{X X}
		...
		\begin{description}
			\item [Current Project] 
				\href{https://github.com/Baricus/BariBot}{BariBot}, a multithreaded, Twitch-specific IRC bot written on ASIO TCP sockets in ongoing development.  
				The bot, implements a subset of the IRC protocol and authenticates with Twitch servers in order to receive chat messages from an arbitrary number of channels.  
				Current work is focused on improving client data storage and implementing end-user commands. 
		\end{description}
